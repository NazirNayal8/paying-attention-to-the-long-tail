...
class Transformer(pl.LightningModule):
    ...
    def test_epoch_end(self, outputs):
        ...
        plt.grid()
        plt.plot(np.arange(self.hparams.num_classes) , acc_per_class.cpu().numpy())
        ...
        plt.figure(figsize=(8,4))
        plt.grid()
        plt.plot(np.arange(self.hparams.num_classes) , precision_per_class.cpu().numpy())
        ...
        plt.figure(figsize=(8,4))
        plt.grid()
        plt.plot(np.arange(self.hparams.num_classes) , f1_per_class.cpu().numpy())
        ...
        plt.figure(figsize=(8,4))
        plt.grid()
        plt.plot(np.arange(self.hparams.num_classes) , [el.cpu().numpy() for el in ap_per_class])
