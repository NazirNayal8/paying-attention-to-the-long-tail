...
default_config_path = 'configs/classification/cifar100_config_local.yaml'
multi_experiment_config_path = 'configs/classification/multi_experiment_cifar100.yaml'
project_name = 'attention_LT_cifar100'
